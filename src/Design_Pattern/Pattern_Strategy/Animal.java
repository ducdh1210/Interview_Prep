...
public class Animal {
	...
	*/
    ...
    // so that any object that is subclass of Animal will call tryToFly() instead of fly()
    // we have abstracted out (encapsulated) the flying behavior into an object whose sole
    // responsibility is to take care of flying behavior
